...
describe("POST to /api/v1/sessions", () => {
  describe("Anonymous user", () => {
    ...
    test("With corret `email` but incorret `password`", async () => {
      await orchestrator.createUser({
    ...
    test("With incorret `email` but incorret `password`", async () => {
      await orchestrator.createUser();
    ...
    test("With corret `email` but corret `password`", async () => {
